...
public class DealBusinessBuyFragment extends BaseFragment
{
    ...
    public void store()
    {
        ...
        else
        {
            ...
            Toast.makeText(getContext(), "请输入价格！", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void deal()
    {
        ...
        String firstContent = "买入价格：" + price;
        String secondContent = "买入数量：" + num;
                            ...
                            ResultData<AccountBean> resultData)
                    {
                        if (resultData.result == 200)
                        {
                            try
                            {
                                ...
                                // mTvBusinessNum
                                // .setText("可买：" + mOwnCurrencyCount);
                                //
                                // if (!TextUtils
                                // .isEmpty(mEtPrice.getText().toString()))
                                // {
                                // if (!mEtPrice.getText()
                                // .toString()
                                // .equals("0"))
    ...
    private void initView()
    {
        ...
        mSaleAdapter
                .setOnItemClickListener(new CommonAdapter.OnItemClickListener()
                {
                    ...
                    {
                        int max = (int) Math.floor(mCash / Double
